...
let named f arg_term =
  Cmdliner.Term.(const f $ arg_term)

let input =
  let doc =
    "The path to the file containing the toplevel phrase to evaluate, pass $(b,-) to read from stdin instead"
  in
